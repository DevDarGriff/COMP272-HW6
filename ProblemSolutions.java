 ...
 ********************************************************************/
 ...
 public class ProblemSolutions {
   ...
   public static int lastBoulder(int[] boulders) {
       ...
       PriorityQueue<Integer> pq = new PriorityQueue<>(Collections.reverseOrder());        //implement reverse order Collections.reverseOrder()

       //add each element from int[] boulders to PriorityQueue
     ...
     public static ArrayList<String> showDuplicates(ArrayList<String> input) {
         ...
         for (String str : input) {
            freqMap.put(str, freqMap.getOrDefault(str, 0) + 1);         ////https://docs.oracle.com/javase/8/docs/api/java/util/Map.html#getOrDefault-java.lang.Object-V-  
         }

         ArrayList<String> dupStrings = new ArrayList<>();

         for (Map.Entry<String, Integer> entry : freqMap.entrySet()) {
            if (entry.getValue() > 1) {
                dupStrings.add(entry.getKey());
            }
         }

         Collections.sort(dupStrings);

         return dupStrings;  // Make sure result is sorted in ascending order
